...
class MovimientoSaldoCuenta extends Component
{
    ...
    */
    ...
    public function CalculaSaldoBancos($listacuentas)
    {
        ...
        foreach ($listacuentas as $item) {
            ...
            if ($item['calcular_traslado_gastos']) {
                ...
                $traslados_gastos = $this->calculaPendienteGastoAndHonorarios($item, $field_fecha, 'GASTO');
            }

            if ($item['calcular_traslado_honorarios']) {
                $field_fecha = 'transactions.fecha_traslado_honorario';
                $traslados_honorarios = $this->calculaPendienteGastoAndHonorarios($item, $field_fecha, 'HONORARIO');
            }
    ...
    {
        // --- Subconsulta 1: transacciones con productos que son del tipo requerido ---
        ...
        $dato = DB::table('transactions as t')
            ...
            ", [$cuenta['moneda_id'], $cuenta['moneda_id']])
            ...
            ->whereNull("t.$field_fecha")       // <-- CORRECTO, solo nombre de columna
