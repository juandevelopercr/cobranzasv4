...
class CasoProductManager extends BaseComponent
{
  use WithFileUploads;
  use WithPagination;
  ...
  #[Url(history: true)]
  public $sortBy = 'casos_productos.nombre';
  ...
  {
    $records = CasoProducto::search($this->search, $this->filters) // Utiliza el scopeSearch para la búsqueda
      ->orderBy($this->sortBy, $this->sortDir)
      ->paginate($this->perPage);

    return view('livewire.clasificadores.casos-products.datatable', [
      'records' => $records,
    ]);
  }
  ...
  public function store()
  {
    ...
    try {
      ...
      $record = CasoProducto::create($validatedData);
  ...
  public function edit($recordId)
  {
    ...
    $record = CasoProducto::find($recordId);
  ...
  public function update()
  {
    ...
    try {
      ...
      $record = CasoProducto::findOrFail($recordId);
