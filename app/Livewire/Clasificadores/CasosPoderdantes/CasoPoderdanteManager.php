...
class CasoPoderdanteManager extends BaseComponent
{
  use WithFileUploads;
  use WithPagination;
  ...
  #[Url(history: true)]
  public $sortBy = 'casos_poderdantes.nombre';
  ...
  {
    $records = CasoPoderdante::search($this->search, $this->filters) // Utiliza el scopeSearch para la búsqueda
      ->orderBy($this->sortBy, $this->sortDir)
      ->paginate($this->perPage);

    return view('livewire.clasificadores.casos-poderdantes.datatable', [
      'records' => $records,
    ]);
  }
  ...
  public function store()
  {
    ...
    try {
      ...
      $record = CasoPoderdante::create($validatedData);
  ...
  public function edit($recordId)
  {
    ...
    $record = CasoPoderdante::find($recordId);
  ...
  public function update()
  {
    ...
    try {
      ...
      $record = CasoPoderdante::findOrFail($recordId);
  ...
  public function refresDatatable()
  {
    $config = DataTableConfig::where('user_id', Auth::id())
      ->where('datatable_name', 'classifier-casos-productos-datatable')
      ->first();
