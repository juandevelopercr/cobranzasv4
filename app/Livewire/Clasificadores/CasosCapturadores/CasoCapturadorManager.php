...
class CasoCapturadorManager extends BaseComponent
{
  use WithFileUploads;
  use WithPagination;
  ...
  #[Url(history: true)]
  public $sortBy = 'casos_capturadores.nombre';
  ...
  {
    $records = CasoCapturador::search($this->search, $this->filters) // Utiliza el scopeSearch para la búsqueda
      ->orderBy($this->sortBy, $this->sortDir)
      ->paginate($this->perPage);

    return view('livewire.clasificadores.casos-capturadores.datatable', [
      'records' => $records,
    ]);
  }
  ...
  public function store()
  {
    ...
    try {
      ...
      $record = CasoCapturador::create($validatedData);
  ...
  public function edit($recordId)
  {
    ...
    $record = CasoCapturador::find($recordId);
  ...
  public function update()
  {
    ...
    try {
      ...
      $record = CasoCapturador::findOrFail($recordId);
