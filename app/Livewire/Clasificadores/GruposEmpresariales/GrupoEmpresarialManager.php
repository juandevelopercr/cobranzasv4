...
class GrupoEmpresarialManager extends BaseComponent
{
  use WithFileUploads;
  use WithPagination;
  ...
  #[Url(history: true)]
  public $sortBy = 'grupos_empresariales.id';
  ...
  {
    $records = GrupoEmpresarial::search($this->search, $this->filters) // Utiliza el scopeSearch para la búsqueda
      ->orderBy($this->sortBy, $this->sortDir)
      ->paginate($this->perPage);

    return view('livewire.clasificadores.grupos-empresariales.datatable', [
      'records' => $records,
    ]);
  }
  ...
  public function store()
  {
    ...
    try {
      ...
      $record = GrupoEmpresarial::create($validatedData);
  ...
  public function edit($recordId)
  {
    ...
    $record = GrupoEmpresarial::find($recordId);
  ...
  public function update()
  {
    ...
    try {
      ...
      $record = GrupoEmpresarial::findOrFail($recordId);
  ...
  public function refresDatatable()
  {
    $config = DataTableConfig::where('user_id', Auth::id())
      ->where('datatable_name', 'classifier-grupos-empresariales-datatable')
      ->first();
