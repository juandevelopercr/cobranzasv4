...
class CasoNotificadorManager extends BaseComponent
{
  use WithFileUploads;
  use WithPagination;
  ...
  #[Url(history: true)]
  public $sortBy = 'casos_notificadores.nombre';
  ...
  {
    $records = CasoNotificador::search($this->search, $this->filters) // Utiliza el scopeSearch para la búsqueda
      ->orderBy($this->sortBy, $this->sortDir)
      ->paginate($this->perPage);

    return view('livewire.clasificadores.casos-notificadores.datatable', [
      'records' => $records,
    ]);
  }
  ...
  public function store()
  {
    ...
    try {
      ...
      $record = CasoNotificador::create($validatedData);
  ...
  public function edit($recordId)
  {
    ...
    $record = CasoNotificador::find($recordId);
  ...
  public function update()
  {
    ...
    try {
      ...
      $record = CasoNotificador::findOrFail($recordId);
  ...
  public function refresDatatable()
  {
    $config = DataTableConfig::where('user_id', Auth::id())
      ->where('datatable_name', 'classifier-casos-notificador-datatable')
      ->first();
