...
class CasoServicioManager extends BaseComponent
{
  use WithFileUploads;
  use WithPagination;
  ...
  #[Url(history: true)]
  public $sortBy = 'casos_servicios.nombre';
  ...
  {
    $records = CasoServicio::search($this->search, $this->filters) // Utiliza el scopeSearch para la búsqueda
      ->orderBy($this->sortBy, $this->sortDir)
      ->paginate($this->perPage);

    return view('livewire.clasificadores.casos-servicios.datatable', [
      'records' => $records,
    ]);
  }
  ...
  public function store()
  {
    ...
    try {
      ...
      $record = CasoServicio::create($validatedData);
  ...
  public function edit($recordId)
  {
    ...
    $record = CasoServicio::find($recordId);
  ...
  public function update()
  {
    ...
    try {
      ...
      $record = CasoServicio::findOrFail($recordId);
  ...
  public function refresDatatable()
  {
    $config = DataTableConfig::where('user_id', Auth::id())
      ->where('datatable_name', 'classifier-casos-servicio-datatable')
      ->first();
