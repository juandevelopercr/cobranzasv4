...
class CasoJuzgadoManager extends BaseComponent
{
  use WithFileUploads;
  use WithPagination;
  ...
  #[Url(history: true)]
  public $sortBy = 'casos_juzgados.nombre';
  ...
  {
    $records = CasoJuzgado::search($this->search, $this->filters) // Utiliza el scopeSearch para la búsqueda
      ->orderBy($this->sortBy, $this->sortDir)
      ->paginate($this->perPage);

    return view('livewire.clasificadores.casos-juzgados.datatable', [
      'records' => $records,
    ]);
  }
  ...
  public function store()
  {
    ...
    try {
      ...
      $record = CasoJuzgado::create($validatedData);
  ...
  public function edit($recordId)
  {
    ...
    $record = CasoJuzgado::find($recordId);
  ...
  public function update()
  {
    ...
    try {
      ...
      $record = CasoJuzgado::findOrFail($recordId);
