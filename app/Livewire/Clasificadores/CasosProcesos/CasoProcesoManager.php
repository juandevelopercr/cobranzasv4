...
class CasoProcesoManager extends BaseComponent
{
  use WithFileUploads;
  use WithPagination;
  ...
  #[Url(history: true)]
  public $sortBy = 'casos_procesos.nombre';
  ...
  {
    $records = CasoProceso::search($this->search, $this->filters) // Utiliza el scopeSearch para la búsqueda
      ->orderBy($this->sortBy, $this->sortDir)
      ->paginate($this->perPage);

    return view('livewire.clasificadores.casos-procesos.datatable', [
      'records' => $records,
    ]);
  }
  ...
  public function store()
  {
    ...
    try {
      ...
      $record = CasoProceso::create($validatedData);
  ...
  public function edit($recordId)
  {
    ...
    $record = CasoProceso::find($recordId);
  ...
  public function update()
  {
    ...
    try {
      ...
      $record = CasoProceso::findOrFail($recordId);
  ...
  public function refresDatatable()
  {
    $config = DataTableConfig::where('user_id', Auth::id())
      ->where('datatable_name', 'classifier-casos-procesos-datatable')
      ->first();
