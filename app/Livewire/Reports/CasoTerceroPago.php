...
class CasoTerceroPago extends Component
{
  public $filter_date;
  ...
  {
    return view('livewire.reports.casos-tercero-pago');
  }
  ...
  public function exportExcel()
  {
    ...
    return Excel::download(new CasoTerceroPagoReport(
      [
      ...
      'REPORTE DE CASOS DE TERCERO ARREGLO DE PAGO ' . $this->filter_date
