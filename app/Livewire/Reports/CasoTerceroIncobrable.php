...
class CasoTerceroIncobrable extends Component
{
  public $filter_date;
  ...
  {
    return view('livewire.reports.casos-tercero-incobrables');
  }
  ...
  public function exportExcel()
  {
    ...
    return Excel::download(new CasoTerceroIncobrableReport(
      [
      ...
      'REPORTE DE CASOS DE TERCERO INCOBRABLE ' . $this->filter_date
