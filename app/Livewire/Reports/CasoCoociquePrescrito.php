...
class CasoCoociquePrescrito extends Component
{
  public $filter_date;
  ...
  {
    return view('livewire.reports.casos-coocique-prescrito');
  }
  ...
  public function exportExcel()
  {
    ...
    return Excel::download(new CasoCoociquePrescritoReport(
      [
      ...
      'REPORTE DE CASOS DE COOCIQUE PRESCRITO ' . $this->filter_date
