...
class CasoCafsaActivo extends Component
{
  //public $filter_date;
  ...
  {
    return view('livewire.reports.casos-cafsa-activos');
  }
  ...
  public function exportExcel()
  {
    ...
    $this->dispatch('start-download', url: route('reports.casos-cafsa-activos.download', ['key' => $key]));
  }
}