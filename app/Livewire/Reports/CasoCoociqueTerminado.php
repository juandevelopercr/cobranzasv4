...
class CasoCoociqueTerminado extends Component
{
  public $filter_date;
  ...
  {
    return view('livewire.reports.casos-coocique-terminados');
  }
  ...
  public function exportExcel()
  {
    ...
    return Excel::download(new CasoCoociqueTerminadoReport(
      [
      ...
      'REPORTE DE CASOS DE COOCIQUE TERMINADOS ' . $this->filter_date
