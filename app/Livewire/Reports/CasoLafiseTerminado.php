...
class CasoLafiseTerminado extends Component
{
  public $filter_date;
  ...
  {
    return view('livewire.reports.casos-lafise-terminados');
  }
  ...
  public function exportExcel()
  {
    ...
    return Excel::download(new CasoLafiseTerminadoReport(
      [
      ...
      'REPORTE DE CASOS DE LAFISE TERMINADOS ' . $this->filter_date
