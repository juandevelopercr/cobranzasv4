...
class CasoCafsaTerminado extends Component
{
  //public $filter_date;
  ...
  {
    return view('livewire.reports.casos-cafsa-terminados');
  }
  ...
  public function exportExcel()
  {
    ...
    return Excel::download(new CasoCafsaTerminadoReport(
      [
      ...
      'REPORTE DE CASOS DE CAFSA TERMINADOS '
