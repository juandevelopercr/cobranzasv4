...
class CasoDaviviendaPagoCE extends Component
{
  public $filter_date;
  ...
  {
    return view('livewire.reports.casos-davivienda-pago-ce');
  }
  ...
  public function exportExcel()
  {
    ...
    return Excel::download(new CasoDaviviendaPagoCEReport(
      [
      ...
      'REPORTE DE CASOS DE DAVIVIENDA PAGO CE ' . $this->filter_date
