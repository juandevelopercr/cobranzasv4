...
class CasoCoocique2Pago extends Component
{
  public $filter_date;
  ...
  {
    return view('livewire.reports.casos-coocique2-pago');
  }
  ...
  public function exportExcel()
  {
    ...
    return Excel::download(new CasoCoocique2PagoReport(
      [
      ...
      'REPORTE DE CASOS DE COOCIQUE 2 ARREGLO DE PAGO ' . $this->filter_date
