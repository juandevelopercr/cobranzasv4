...
class CasoTerceroActivo extends Component
{
  public $filter_date;
  ...
  {
    return view('livewire.reports.casos-tercero-activos');
  }
  ...
  public function exportExcel()
  {
    ...
    return Excel::download(new CasoTerceroActivoReport(
      [
      ...
      'REPORTE DE CASOS DE TERCERO ACTIVOS ' . $this->filter_date
