...
class CasoTerceroTerminado extends Component
{
  public $filter_date;
  ...
  {
    return view('livewire.reports.casos-tercero-terminados');
  }
  ...
  public function exportExcel()
  {
    ...
    return Excel::download(new CasoTerceroTerminadoReport(
      [
      ...
      'REPORTE DE CASOS DE TERCERO TERMINADOS ' . $this->filter_date
