...
class CasoCoociquePago extends Component
{
  public $filter_date;
  ...
  {
    return view('livewire.reports.casos-coocique-pago');
  }
  ...
  public function exportExcel()
  {
    ...
    return Excel::download(new CasoCoociquePagoReport(
      [
      ...
      'REPORTE DE CASOS DE COOCIQUE ARREGLO DE PAGO ' . $this->filter_date
