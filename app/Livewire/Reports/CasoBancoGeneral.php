...
class CasoBancoGeneral extends Component
{
  public $filter_date;
  ...
  {
    return view('livewire.reports.casos-banco-general');
  }
  ...
  public function exportExcel()
  {
    ...
    return Excel::download(new CasoBancoGeneralReport(
      [
      ...
      'REPORTE DE CASOS DE BANCO GENERAL ' . $this->filter_date
