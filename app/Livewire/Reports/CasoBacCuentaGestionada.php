...
class CasoBacCuentaGestionada extends Component
{
  public $filter_date;
  ...
  {
    return view('livewire.reports.casos-bac-cuentas-gestionadas');
  }
  ...
  public function exportExcel()
  {
    ...
    return Excel::download(new CasoBacGestionadaReport(
      [
      ...
      'REPORTE DE CASOS DE BAC CUENTAS GESTIONADAS ' . $this->filter_date
