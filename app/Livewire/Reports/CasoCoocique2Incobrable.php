...
class CasoCoocique2Incobrable extends Component
{
  public $filter_date;
  ...
  {
    return view('livewire.reports.casos-coocique2-incobrables');
  }
  ...
  public function exportExcel()
  {
    ...
    return Excel::download(new CasoCoocique2IncobrableReport(
      [
      ...
      'REPORTE DE CASOS DE COOCIQUE 2 INCOBRABLES ' . $this->filter_date
