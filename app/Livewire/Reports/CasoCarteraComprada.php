...
class CasoCarteraComprada extends Component
{
  public $filter_date;
  ...
  {
    return view('livewire.reports.casos-cartera-comprada');
  }
  ...
  public function exportExcel()
  {
    ...
    return Excel::download(new CasoCarteraCompradaReport(
      [
      ...
      'REPORTE DE CASOS DE CARTERA COMPRADA ' . $this->filter_date
