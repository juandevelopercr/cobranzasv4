...
class CasoLafiseActivo extends Component
{
  public $filter_date;
  ...
  {
    return view('livewire.reports.casos-lafise-activos');
  }
  ...
  public function exportExcel()
  {
    ...
    return Excel::download(new CasoLafiseActivoReport(
      [
      ...
      'REPORTE DE CASOS DE LAFISE ACTIVOS ' . $this->filter_date
