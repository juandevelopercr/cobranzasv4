...
class CasoDaviviendaPagoTC extends Component
{
  public $filter_date;
  ...
  {
    return view('livewire.reports.casos-davivienda-pago-tc');
  }
  ...
  public function exportExcel()
  {
    ...
    return Excel::download(new CasoDaviviendaPagoTCReport(
      [
      ...
      'REPORTE DE CASOS DE DAVIVIENDA PAGO TC ' . $this->filter_date
