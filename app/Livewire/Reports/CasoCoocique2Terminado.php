...
class CasoCoocique2Terminado extends Component
{
  public $filter_date;
  ...
  {
    return view('livewire.reports.casos-coocique2-terminados');
  }
  ...
  public function exportExcel()
  {
    ...
    return Excel::download(new CasoCoocique2TerminadoReport(
      [
      ...
      'REPORTE DE CASOS DE COOCIQUE 2 TERMINADOS ' . $this->filter_date
