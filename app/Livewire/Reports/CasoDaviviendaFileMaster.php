...
class CasoDaviviendaFileMaster extends Component
{
  public $filter_date;
  ...
  {
    return view('livewire.reports.casos-davivienda-file-master');
  }
  ...
  public function exportExcel()
  {
    ...
    return Excel::download(new CasoDaviviendaFileMasterReport(
      [
      ...
      'REPORTE DE CASOS DE DAVIVIENDA FILE MASTER ' . $this->filter_date
