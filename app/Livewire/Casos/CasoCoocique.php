...
class CasoCoocique extends CasoManager
{
  protected string $deletePermission = 'delete-coocique-casos';
  ...
  public function render()
  {
    ...
    return view('livewire.casos.coocique-datatable', [
      'records' => $records,
    ]);
  }
  ...
  public function edit($recordId)
{
  ...
  public function refresDatatable()
  {
    $config = DataTableConfig::where('user_id', Auth::id())
      ->where('datatable_name', 'casos-coocique-datatable')
      ->first();
      ...
      for ($r = 1; $r < count($sheet); $r++) {
          ...
          if ($pnumero) {
              $caso = \App\Models\Caso::where([
                  'pnumero' => $pnumero,
                  'bank_id' => Bank::COOCIQUE
              ])->first();
          }
          if (!$caso) {
              $caso = new \App\Models\Caso();
              $caso->bank_id = Bank::COOCIQUE;
  ...
  public function importar()
  {
    ...
    for ($r = 1; $r < count($sheet); $r++) {
        ...
        if ($pnumero) {
            ...
            if ($caso && $caso->bank_id != Bank::COOCIQUE){
