...
class CasoLafise extends CasoManager
{
  ...
  public function render()
  {
    ...
    return view('livewire.casos.lafise-datatable', [
      'records' => $records,
    ]);
  }
  ...
  public function edit($recordId)
{
  ...
  */
  ...
  public function importar()
  {
    ...
    $columns = ImportColumns::getColumnasPorBanco(Bank::LAFISE);
    ...
    for ($r = 1; $r < count($sheet); $r++) {
        ...
        if ($pnumero) {
            ...
            if ($caso && $caso->bank_id != Bank::LAFISE){
  ...
  {
      $fileName = "plantilla_casos_lafise.xlsx";
      return Excel::download(new CasosTemplateExport(Bank::LAFISE), $fileName);
  }
}
