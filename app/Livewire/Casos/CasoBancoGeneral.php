...
class CasoBancoGeneral extends CasoManager
{
  ...
  {
    $this->bank_id = Bank::BANCOGENERAL;
    $CONCURSALES   = 78;
    $LETRADECAMBIO = 31;
    $PAGARE        = 32;
  ...
  public function render()
  {
    ...
    return view('livewire.casos.banco-general-datatable', [
      'records' => $records,
    ]);
  }
  ...
  */
  public function importar()
  {
    ...
    $columns = ImportColumns::getColumnasPorBanco(Bank::BANCOGENERAL);
    ...
    for ($r = 1; $r < count($sheet); $r++) {
        ...
        if ($pnumero) {
            ...
            if ($caso && $caso->bank_id != Bank::BANCOGENERAL){
