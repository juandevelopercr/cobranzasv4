...
class CasoTerceros extends CasoManager
{
  ...
  public function render()
  {
    ...
    return view('livewire.casos.terceros-datatable', [
      'records' => $records,
    ]);
  }
  ...
  public function edit($recordId)
{
  ...
  public function refresDatatable()
  {
    $config = DataTableConfig::where('user_id', Auth::id())
      ->where('datatable_name', 'casos-terceros-datatable')
      ->first();
  ...
  */
  ...
  public function importar()
  {
    ...
    $columns = ImportColumns::getColumnasPorBanco(Bank::TERCEROS);
    ...
    for ($r = 1; $r < count($sheet); $r++) {
        ...
        if ($pnumero) {
            ...
            if ($caso && $caso->bank_id != Bank::TERCEROS){
