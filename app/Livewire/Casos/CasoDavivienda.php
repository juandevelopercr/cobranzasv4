...
class CasoDavivienda extends CasoManager
{
  ...
  public function render()
  {
    ...
    return view('livewire.casos.davivienda-datatable', [
      'records' => $records,
    ]);
  }
  ...
  public function rules(): array
  {
    $rules = [
      ...
      'pmonto_estimacion_demanda_colones' => ['nullable', 'numeric'],
      ...
      'aestimacion_demanda_en_presentacion' => ['nullable', 'numeric'],
      'aestimacion_demanda_en_presentacion_usd' => ['nullable', 'numeric'],
      'liquidacion_intereses_aprobada_crc' => ['nullable', 'numeric'],
      'liquidacion_intereses_aprobada_usd' => ['nullable', 'numeric'],
      'agastos_legales' => ['nullable', 'numeric'],
      'ahonorarios_totales' => ['nullable', 'numeric'],
      'ahonorarios_totales_usd' => ['nullable', 'numeric'],
      'amonto_cancelar' => ['nullable', 'numeric'],
      'amonto_incobrable' => ['nullable', 'numeric'],
      'amonto_avaluo' => ['nullable', 'numeric'],
      'psaldo_dolarizado' => ['nullable', 'numeric'],
      'pnombre_demandado' => ['nullable', 'string', 'max:190'],
      'bgastos_proceso' => ['nullable', 'numeric'],
  ...
  public function edit($recordId)
{
  ...
  public function refresDatatable()
  {
    $config = DataTableConfig::where('user_id', Auth::id())
      ->where('datatable_name', 'casos-davivienda-datatable')
      ->first();
  ...
  public function getDefaultColumns()
  {
    $this->defaultColumns = [
      ...
      [
        'field' => 'pnumero_operacion2',
        'orderName' => 'pnumero_operacion2',
        'label' => __('Número Operación2'),
        'filter' => 'filter_pnumero_operacion2',
        'filter_type' => 'input',
        'filter_sources' => '',
        'filter_source_field' => '',
        'columnType' => 'string',
      ...
      [
        'field' => 'pnombre_apellidos_deudor',
        'orderName' => 'pnombre_apellidos_deudor',
        'label' => __('Nombre y Apellidos Deudor'),
        'filter' => 'filter_pnombre_apellidos_deudor',
        'filter_type' => 'input',
        'filter_sources' => '',
        'filter_source_field' => '',
        'columnType' => 'string',
      ...
      [
        'field' => 'pcedula_deudor',
        'orderName' => 'pcedula_deudor',
        'label' => __('Cédula Deudor'),
        'filter' => 'filter_pcedula_deudor',
        'filter_type' => 'input',
        'filter_sources' => '',
        'filter_source_field' => '',
        'columnType' => 'string',
      ...
      [
        'field' => 'nestado_actual_primera_notificacion',
        'orderName' => 'nestado_actual_primera_notificacion',
        'label' => __('Estado actual primera notificación demandados'),
        'filter' => 'filter_nestado_actual_primera_notificacion',
        'filter_type' => 'input',
        'filter_sources' => '',
        'filter_source_field' => '',
        'columnType' => 'string',
      ...
      for ($r = 1; $r < count($sheet); $r++) {
          ...
          if ($pnumero) {
              $caso = \App\Models\Caso::where([
                  'pnumero' => $pnumero,
                  'bank_id' => Bank::DAVIVIENDA
              ])->first();
          }
          if (!$caso) {
              $caso = new \App\Models\Caso();
              $caso->bank_id = Bank::DAVIVIENDA;
  ...
  */
  ...
  public function importar()
  {
    ...
    for ($r = 1; $r < count($sheet); $r++) {
        ...
        if ($pnumero) {
            ...
            if ($caso && $caso->bank_id != Bank::DAVIVIENDA){
  ...
  {
      $fileName = "plantilla_casos_davivienda.xlsx";
      return Excel::download(new CasosTemplateExport(Bank::DAVIVIENDA), $fileName);
  }
