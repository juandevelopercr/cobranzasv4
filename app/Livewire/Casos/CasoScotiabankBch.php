...
class CasoScotiabankBch extends CasoManager
{
  protected string $deletePermission = 'delete-scotiabank-bch-casos';
  ...
  {
    $this->bank_id = Bank::SCOTIABANKBCH;
    $CONCURSALES   = 78;
    $LETRADECAMBIO = 31;
    $PAGARE        = 32;
    ...
    */
    ...
    $this->expectedColumns = ImportColumns::getColumnasPorBanco(Bank::SCOTIABANKBCH);
  ...
  public function render()
  {
    ...
    return view('livewire.casos.scotiabanks-bch-datatable', [
      'records' => $records,
    ]);
  }
  ...
  public function edit($recordId)
{
  ...
  public function importar()
  {
    ...
    $columns = ImportColumns::getColumnasPorBanco(Bank::SCOTIABANKBCH);
    ...
    for ($r = 1; $r < count($sheet); $r++) {
        ...
        if ($pnumero) {
            ...
            if ($caso && $caso->bank_id != Bank::SCOTIABANKBCH){
        ...
        if ($caso) {
            ...
            $caso->bank_id = Bank::SCOTIABANKBCH;
  ...
  public function descargarPlantilla()
  {
      ...
      return Excel::download(new CasosTemplateExport(Bank::SCOTIABANKBCH), $fileName);
  }
}
