...
class AntiguedadReport extends BaseReport
{
  ...
  public function query(): \Illuminate\Database\Eloquent\Builder
  {
      ...
      // Construir subquery para sumar solo los percent de centros permitidos
      $ccSubQuery = "(
      ...
      // Si hay exclusión de centros de costo, eliminar transacciones que quedaron con 0% después del filter
      if (!empty($centrosExcluyentes)) {
          $query->havingRaw('SUM(cc_sum.percent) > 0');
      }
