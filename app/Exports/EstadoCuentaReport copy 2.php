...
class EstadoCuentaReport implements FromArray, WithHeadings, WithEvents
{
    protected $filters;
    protected $title;
    ...
    public function array(): array
    {
        ...
        // Fila 1: Título (se manejará en registerEvents)
        // Fila 2: Logo (se manejará en registerEvents)
        ...
        $currentRow = 3; // Empezar en fila 3 (después de título y logo)
    ...
    {
        return []; // No usamos headings automáticos
    }
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $currentRow = 3; // Empezar en fila 3
