...
class CasoCoocique2IncobrableReport extends BaseReport
{
  protected function columns(): array
  {
    return [
      ...
      ['label' => 'Monto de la demanda', 'field' => 'pmonto_estimacion_demanda', 'type' => 'string', 'align' => 'center', 'width' => 20],
  ...
  public function query(): \Illuminate\Database\Eloquent\Builder
  {
    ...
    ->where('casos.bank_id', Bank::COOCIQUE2)
