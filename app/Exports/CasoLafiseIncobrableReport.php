...
class CasoLafiseIncobrableReport extends BaseReport
{
  protected function columns(): array
  {
    return [
      ...
      ['label' => 'Fecha de traslado de la demanda', 'field' => 'nfecha_traslado_juzgado', 'type' => 'string', 'align' => 'center', 'width' => 15],
      ['label' => 'Fecha de finalización del proceso', 'field' => 'afecha_terminacion', 'type' => 'string', 'align' => 'center', 'width' => 15],
      ['label' => 'Fecha de notificación de las partes', 'field' => 'nfecha_notificacion_todas_partes', 'type' => 'string', 'align' => 'center', 'width' => 15],
      ['label' => 'Estado actual de la primera notificación de los demandados', 'field' => 'estado_notificacion', 'type' => 'string', 'align' => 'center', 'width' => 15],
      ...
      ['label' => 'Fecha de última acción judicial', 'field' => 'afecha_informe_ultima_gestion', 'type' => 'string', 'align' => 'center', 'width' => 15],
      ...
      ['label' => 'Fecha Avaluo', 'field' => 'afecha_avaluo', 'type' => 'string', 'align' => 'center', 'width' => 15],
      ...
      ['label' => 'Fecha de último giro', 'field' => 'afecha_ultimo_giro', 'type' => 'string', 'align' => 'center', 'width' => 15],
      ['label' => 'Captura', 'field' => 'sfecha_captura', 'type' => 'string', 'align' => 'center', 'width' => 15],
      ...
      ['label' => 'Fecha de firmeza de aprobación de remate', 'field' => 'afecha_aprobacion_remate', 'type' => 'string', 'align' => 'center', 'width' => 15],
