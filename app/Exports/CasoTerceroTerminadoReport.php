...
class CasoTerceroTerminadoReport extends BaseReport
{
  protected function columns(): array
  {
    ...
    return [
      ...
      ['label' => 'Fecha de asignación', 'field' => 'pfecha_asignacion_caso', 'type' => 'string', 'align' => 'center', 'width' => 15],
      ['label' => 'Fecha de traslado de juzgado', 'field' => 'nfecha_traslado_juzgado', 'type' => 'string', 'align' => 'center', 'width' => 15],
      ['label' => 'Fecha de notificación todas las partes', 'field' => 'nfecha_notificacion_todas_partes', 'type' => 'string', 'align' => 'center', 'width' => 15],
      ['label' => 'Fecha de Última liquidación', 'field' => 'nfecha_ultima_liquidacion', 'type' => 'string', 'align' => 'center', 'width' => 15],
      ['label' => 'Fecha de presentación de embargo', 'field' => 'afecha_presentacion_embargo', 'type' => 'string', 'align' => 'center', 'width' => 15],
      ['label' => 'Fecha de arreglo de pago', 'field' => 'afecha_arreglo_pago', 'type' => 'string', 'align' => 'center', 'width' => 15],
      ...
      ['label' => 'Fecha de pago', 'field' => 'afecha_pago', 'type' => 'string', 'align' => 'center', 'width' => 15],
      ...
      ['label' => 'Fecha de de inscripción', 'field' => 'afecha_inscripcion', 'type' => 'string', 'align' => 'center', 'width' => 15],
      ...
      ['label' => 'Fecha de suspensión por arreglo', 'field' => 'afecha_suspencion_arreglo', 'type' => 'string', 'align' => 'center', 'width' => 15],
