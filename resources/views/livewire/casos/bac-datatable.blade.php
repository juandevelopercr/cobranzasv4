<div>
  <div wire:key="list-container-persistent" :class="{ 'd-none': $wire.action !== 'list' }">
    ...
    <div class="card">
      <h5 class="card-header pb-0 text-md-start text-center">{{ __('Casos de BAC') }}</h5>
        ...
        <div class="dataTables_wrapper dt-bootstrap5 no-footer">
          ...
          @can("view-bac-casos")
            <div class="card-datatable table-responsive">
              <table class="table table-sm mb-0 border-top table-hover dataTable no-footer" id="casos-bac-table" style="width: 100%;">
                <thead>
                  <tr>
...
<script>
  function printTable() {
      ...
      const printContent = document.getElementById('casos-bac-table').innerHTML;
