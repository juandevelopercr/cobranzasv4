<div>
  @if($action == 'list')
    ...
    <div class="card">
      <h5 class="card-header pb-0 text-md-start text-center">{{ __('Casos de Scotiabank BCH') }}</h5>
        ...
        <div class="dataTables_wrapper dt-bootstrap5 no-footer">
          ...
          @can("view-scotiabank-bch-casos")
            <div class="card-datatable table-responsive">
              <table class="table table-sm mb-0 border-top table-hover dataTable no-footer" id="casos-scotiabank-bch-table" style="width: 100%;">
                <thead>
                  <tr>
