<div>
    <div wire:key="list-container-persistent" :class="{ 'd-none': $wire.action !== 'list' }">
        ...
        <div class="card">
            <h5 class="card-header pb-0 text-md-start text-center">{{ __('Casos de Davibank BCH') }}</h5>
...
@endcan
                  */
                                    ...
                                    @can('delete-scotiabank-bch-casos')
                                    ...
                                    @livewire(
                                        ...
                                        key('classifier-casos-scotiabanks-bch-config')
                                    )
                                </div>
                            </div>
                        </div>
    ...
    <div wire:key="form-container-persistent" :class="{ 'd-none': $wire.action !== 'create' && $wire.action !== 'edit' }">
        @include('livewire.casos.partials.scotiabank-bch.form')
    </div>
...
@push('scripts')
    <script>
        function printTable() {
            ...
            const printContent = document.getElementById('casos-scotiabank-bch-table').innerHTML;
