<div>
  <div wire:key="list-container-persistent" :class="{ 'd-none': $wire.action !== 'list' }">
    ...
    <div class="card">
      <h5 class="card-header pb-0 text-md-start text-center">{{ __('Casos de Lafise') }}</h5>
              ...
              <div
                ...
                <div class="dt-buttons btn-group flex-wrap">
                  ...
                  */
                  ...
                  'datatableName' => 'casos-lafise-datatable',
                  'availableColumns' => $this->columns,
                  'perPage' => $this->perPage,
                  ],
                  key('livewire.casos.lafise-config'))
                </div>
              </div>
            </div>
          </div>

          @can("view-lafise-casos")
            <div class="card-datatable table-responsive">
              <table class="table table-sm mb-0 border-top table-hover dataTable no-footer" id="casos-lafise-table" style="width: 100%;">
                <thead>
                  <tr>
...
<script>
  function printTable() {
      ...
      const printContent = document.getElementById('casos-lafise-table').innerHTML;
