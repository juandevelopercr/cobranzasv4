              ...
              <div
                ...
                <div class="dt-buttons btn-group flex-wrap">
                  ...
                  */
                  ...
                  'datatableName' => 'casos-cartera-datatable',
                  'availableColumns' => $this->columns,
                  'perPage' => $this->perPage,
                  ],
                  key('livewire.casos.cartera-config'))
                </div>
              </div>
            </div>
          </div>

          @can("view-cartera-casos")
            <div class="card-datatable table-responsive">
              <table class="table table-sm mb-0 border-top table-hover dataTable no-footer" id="casos-cartera-table" style="width: 100%;">
                <thead>
                  <tr>
...
<script>
  function printTable() {
      ...
      const printContent = document.getElementById('casos-cartera-table').innerHTML;
