<div>
  @if($action == 'list')
    ...
    <div class="card">
      <h5 class="card-header pb-0 text-md-start text-center">{{ __('Casos de Davivienda') }}</h5>
            ...
            <div class="col-md-10">
              <div
                ...
                <div class="dt-buttons btn-group flex-wrap">
                  ...
                  'datatableName' => 'livewire.casos.davivienda-datatable',
                  'availableColumns' => $this->columns,
                  'perPage' => $this->perPage,
                  ],
                  key('livewire.casos.davivienda-config'))
                </div>
              </div>
            </div>
          </div>

          @can("view-davivienda-casos")
  ...
  @if($action == 'create' || $action == 'edit')
    @include('livewire.casos.partials.davivienda.form')
  @endif
</div>
...
<script>
  function printTable() {
      ...
      const printContent = document.getElementById('casos-davivienda-table').innerHTML;
