<div>
  <div wire:key="list-container-persistent" :class="{ 'd-none': $wire.action !== 'list' }">
    ...
    <div class="card">
      <h5 class="card-header pb-0 text-md-start text-center">{{ __('Casos de Coocique') }}</h5>
              ...
              <div
                ...
                <div class="dt-buttons btn-group flex-wrap">
                  ...
                  */
                  ...
                  'datatableName' => 'casos-coocique-datatable',
                  'availableColumns' => $this->columns,
                  'perPage' => $this->perPage,
                  ],
                  key('livewire.casos.coocique-config'))
                </div>
              </div>
            </div>
          </div>

          @can("view-coocique-casos")
            <div class="card-datatable table-responsive">
              <table class="table table-sm mb-0 border-top table-hover dataTable no-footer" id="casos-coocique-table" style="width: 100%;">
                <thead>
                  <tr>
  ...
  <div wire:key="form-container-persistent" :class="{ 'd-none': $wire.action !== 'create' && $wire.action !== 'edit' }">
    @include('livewire.casos.partials.coocique.form')
  </div>
...
<script>
  function printTable() {
      ...
      const printContent = document.getElementById('casos-coocique-table').innerHTML;
