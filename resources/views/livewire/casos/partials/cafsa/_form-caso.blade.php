...
<div class="card border-0 mb-7">
  <div class="card-body panel-card bg-light-blue">
    ...
    @include('livewire.casos.partials.cafsa.panels.info-caso')
  </div>
</div>
@endif
...
<div class="card border-0 mb-7">
  <div class="card-body panel-card bg-light-gray">
    ...
    @include('livewire.casos.partials.cafsa.panels.notificacion-caso')
  </div>
</div>
@endif
...
<div class="card border-0 mb-7">
  <div class="card-body panel-card bg-light-yellow">
    ...
    @include('livewire.casos.partials.cafsa.panels.sentencia-caso')
  </div>
</div>
@endif
...
<div class="card border-0 mb-7">
  <div class="card-body panel-card bg-light-green">
    ...
    @include('livewire.casos.partials.cafsa.panels.arreglo-caso')
  </div>
</div>
@endif
...
<div class="card border-0 mb-7">
  <div class="card-body panel-card bg-light-cyan">
    ...
    @include('livewire.casos.partials.cafsa.panels.aprobacion-caso')
  </div>
</div>
@endif
...
<div class="card border-0 mb-7">
  <div class="card-body panel-card bg-light-pink">
    ...
    @include('livewire.casos.partials.cafsa.panels.traspaso-caso')
  </div>
</div>
@endif
...
<div class="card border-0 mb-7">
  <div class="card-body panel-card bg-light-red">
    ...
    @include('livewire.casos.partials.cafsa.panels.terminacion-caso')
  </div>
</div>
@endif
...
<div class="card border-0 mb-7">
  <div class="card-body panel-card bg-light-cyan">
    ...
    @include('livewire.casos.partials.cafsa.panels.facturacion-caso')
  </div>
</div>
@endif
...
<div class="card border-0 mb-7">
  <div class="card-body panel-card bg-light-mint">
    ...
    @include('livewire.casos.partials.cafsa.panels.segmento-caso')
  </div>
</div>
@endif
...
<div class="card border-0 mb-7">
  <div class="card-body panel-card bg-light-coral">
    ...
    @include('livewire.casos.partials.cafsa.panels.denuncia-caso')
  </div>
</div>
@endif
...
<div class="card border-0 mb-7">
  <div class="card-body panel-card bg-light-beige">
    ...
    @include('livewire.casos.partials.cafsa.panels.anotaciones-caso')
  </div>
</div>
@endif
...
<div class="card border-0 mb-7">
  <div class="card-body panel-card bg-light-green">
    ...
    @include('livewire.casos.partials.cafsa.panels.bienes-caso')
  </div>
</div>
@endif
...
<div class="card border-0 mb-7">
  <div class="card-body panel-card bg-light-red">
    ...
    @include('livewire.casos.partials.cafsa.panels.filtro1-caso')
  </div>
</div>
@endif
...
<div class="card border-0 mb-7">
  <div class="card-body panel-card bg-light-red">
    ...
    @include('livewire.casos.partials.cafsa.panels.filtro2-caso')
  </div>
</div>
@endif
