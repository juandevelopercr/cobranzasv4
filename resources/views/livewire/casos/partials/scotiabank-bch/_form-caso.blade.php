...
<div class="card border-0 mb-7">
  <div class="card-body panel-card bg-light-blue">
    ...
    @include('livewire.casos.partials.scotiabank-bch.panels.info-caso')
  </div>
</div>
@endif
...
<div class="card border-0 mb-7">
  <div class="card-body panel-card bg-light-gray">
    ...
    @include('livewire.casos.partials.scotiabank-bch.panels.notificacion-caso')
  </div>
</div>
@endif
...
<div class="card border-0 mb-7">
  <div class="card-body panel-card bg-light-yellow">
    ...
    @include('livewire.casos.partials.scotiabank-bch.panels.sentencia-caso')
  </div>
</div>
@endif
...
<div class="card border-0 mb-7">
  <div class="card-body panel-card bg-light-green">
    ...
    @include('livewire.casos.partials.scotiabank-bch.panels.arreglo-caso')
  </div>
</div>
@endif
...
<div class="card border-0 mb-7">
  <div class="card-body panel-card bg-light-cyan">
    ...
    @include('livewire.casos.partials.scotiabank-bch.panels.aprobacion-caso')
  </div>
</div>
@endif
...
<div class="card border-0 mb-7">
  <div class="card-body panel-card bg-light-pink">
    ...
    @include('livewire.casos.partials.scotiabank-bch.panels.traspaso-caso')
  </div>
</div>
@endif
...
<div class="card border-0 mb-7">
  <div class="card-body panel-card bg-light-red">
    ...
    @include('livewire.casos.partials.scotiabank-bch.panels.terminacion-caso')
  </div>
</div>
@endif
...
<div class="card border-0 mb-7">
  <div class="card-body panel-card bg-light-green">
    ...
    @include('livewire.casos.partials.scotiabank-bch.panels.levantamiento-caso')
  </div>
</div>
@endif
...
<div class="card border-0 mb-7">
  <div class="card-body panel-card bg-light-cyan">
    ...
    @include('livewire.casos.partials.scotiabank-bch.panels.facturacion-caso')
  </div>
</div>
@endif
...
<div class="card border-0 mb-7">
  <div class="card-body panel-card bg-light-mint">
    ...
    @include('livewire.casos.partials.scotiabank-bch.panels.segmento-caso')
  </div>
</div>
@endif
...
<div class="card border-0 mb-7">
  <div class="card-body panel-card bg-light-coral">
    ...
    @include('livewire.casos.partials.scotiabank-bch.panels.denuncia-caso')
  </div>
</div>
@endif
...
<div class="card border-0 mb-7">
  <div class="card-body panel-card bg-light-beige">
    ...
    @include('livewire.casos.partials.scotiabank-bch.panels.anotaciones-caso')
  </div>
</div>
@endif
...
<div class="card border-0 mb-7">
  <div class="card-body panel-card bg-light-green">
    ...
    @include('livewire.casos.partials.scotiabank-bch.panels.bienes-caso')
  </div>
</div>
@endif
...
<div class="card border-0 mb-7">
  <div class="card-body panel-card bg-light-red">
    ...
    @include('livewire.casos.partials.scotiabank-bch.panels.filtro1-caso')
  </div>
</div>
@endif
...
<div class="card border-0 mb-7">
  <div class="card-body panel-card bg-light-red">
    ...
    @include('livewire.casos.partials.scotiabank-bch.panels.filtro2-caso')
  </div>
</div>
@endif
