<div class="row g-6">
    ...
    <div
      x-data="cleaveLivewire({
        ...
        rawValueCallback: (val) => {
          ...
          if (component) {
            component.set('psaldo_dolarizado', val);
          }
        },
 ...
 <div class="col-12 col-sm-6 col-md-4 col-lg-3 fv-plugins-icon-container">
  ...
  <div class="col-12 col-sm-6 col-md-4 col-lg-3 fv-plugins-icon-container">
    <label class="form-label" for="pdatos_codeudor1">{{ __('Datos Codeudor1 (Bullet Point)') }}</label>
    <div class="input-group input-group-merge has-validation">
  ...
  <div class="col-12 col-sm-6 col-md-4 col-lg-3 fv-plugins-icon-container">
    <label class="form-label" for="pdatos_codeudor2">{{ __('Datos Codeudor2 (Bullet Point)') }}</label>
    <div class="input-group input-group-merge has-validation">
  ...
  <div class="col-12 col-sm-12 col-md-6 col-lg-6 fv-plugins-icon-container">
    ...
    <textarea class="form-control" wire:model="pubicacion_garantia" name="pubicacion_garantia" id="pubicacion_garantia" rows="5"></textarea>
  ...
  @php
    $this->empresa = 'C.C.C. COBRANZAS COMERCIALES S.A.';
  @endphp
  <div class="col-12 col-sm-6 col-md-4 col-lg-3 fv-plugins-icon-container">
    <label class="form-label" for="empresa">{{ __('Nombre de la Empresa') }}</label>
    <div class="input-group input-group-merge has-validation">
      <input type="text" wire:model="empresa" id="empresa" class="form-control @error('empresa') is-invalid @enderror" readonly>
    </div>
    @error('empresa')
    <div class="text-danger mt-1">{{ $message }}</div>
    @enderror
  ...
  <div class="col-12 col-sm-6 col-md-4 col-lg-3 select2-primary fv-plugins-icon-container">
    ...
    <div wire:ignore>
      <select wire:model="pplazo_arreglo_pago" id="pplazo_arreglo_pago" class="select2 form-select @error('pplazo_arreglo_pago') is-invalid @enderror">
        <option value="">{{ __('Seleccione...') }}</option>
