...
<div class="card border-0 mb-7">
  <div class="card-body panel-card bg-light-blue">
    ...
    @include('livewire.casos.partials.terceros.panels.info-caso')
  </div>
</div>
@endif
...
<div class="card border-0 mb-7">
  <div class="card-body panel-card bg-light-gray">
    ...
    @include('livewire.casos.partials.terceros.panels.notificacion-caso')
  </div>
</div>
@endif
...
<div class="card border-0 mb-7">
  <div class="card-body panel-card bg-light-yellow">
    ...
    @include('livewire.casos.partials.terceros.panels.sentencia-caso')
  </div>
</div>
@endif
...
<div class="card border-0 mb-7">
  <div class="card-body panel-card bg-light-green">
    ...
    @include('livewire.casos.partials.terceros.panels.arreglo-caso')
  </div>
</div>
@endif
...
<div class="card border-0 mb-7">
  <div class="card-body panel-card bg-light-cyan">
    ...
    @include('livewire.casos.partials.terceros.panels.aprobacion-caso')
  </div>
</div>
@endif
...
<div class="card border-0 mb-7">
  <div class="card-body panel-card bg-light-pink">
    ...
    @include('livewire.casos.partials.terceros.panels.traspaso-caso')
  </div>
</div>
@endif
...
<div class="card border-0 mb-7">
  <div class="card-body panel-card bg-light-red">
    ...
    @include('livewire.casos.partials.terceros.panels.terminacion-caso')
  </div>
</div>
@endif
...
<div class="card border-0 mb-7">
  <div class="card-body panel-card bg-light-green">
    ...
    @include('livewire.casos.partials.terceros.panels.levantamiento-caso')
  </div>
</div>
@endif
...
<div class="card border-0 mb-7">
  <div class="card-body panel-card bg-light-cyan">
    ...
    @include('livewire.casos.partials.terceros.panels.facturacion-caso')
  </div>
</div>
@endif
...
<div class="card border-0 mb-7">
  <div class="card-body panel-card bg-light-mint">
    ...
    @include('livewire.casos.partials.terceros.panels.segmento-caso')
  </div>
</div>
@endif
...
<div class="card border-0 mb-7">
  <div class="card-body panel-card bg-light-coral">
    ...
    @include('livewire.casos.partials.terceros.panels.denuncia-caso')
  </div>
</div>
@endif
...
<div class="card border-0 mb-7">
  <div class="card-body panel-card bg-light-beige">
    ...
    @include('livewire.casos.partials.terceros.panels.anotaciones-caso')
  </div>
</div>
@endif
...
<div class="card border-0 mb-7">
  <div class="card-body panel-card bg-light-green">
    ...
    @include('livewire.casos.partials.terceros.panels.bienes-caso')
  </div>
</div>
@endif
...
<div class="card border-0 mb-7">
  <div class="card-body panel-card bg-light-red">
    ...
    @include('livewire.casos.partials.terceros.panels.filtro1-caso')
  </div>
</div>
@endif
...
<div class="card border-0 mb-7">
  <div class="card-body panel-card bg-light-red">
    ...
    @include('livewire.casos.partials.terceros.panels.filtro2-caso')
  </div>
</div>
@endif
