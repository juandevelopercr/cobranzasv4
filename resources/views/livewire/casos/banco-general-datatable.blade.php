<div>
  <div wire:key="list-container-persistent" :class="{ 'd-none': $wire.action !== 'list' }">
    ...
    <div class="card">
      <h5 class="card-header pb-0 text-md-start text-center">{{ __('Casos de Banco General') }}</h5>
              ...
              <div
                ...
                <div class="dt-buttons btn-group flex-wrap">
                  ...
                  */
                  ...
                  @can("delete-banco-general-casos")
                  ...
                  'datatableName' => 'casos-banco-genetral-datatable',
                  'availableColumns' => $this->columns,
                  'perPage' => $this->perPage,
                  ],
                  key('livewire.casos.banco-general-config'))
                </div>
              </div>
            </div>
          </div>

          @can("view-banco-general-casos")
            <div class="card-datatable table-responsive">
              <table class="table table-sm mb-0 border-top table-hover dataTable no-footer" id="casos-banco-general-table" style="width: 100%;">
                <thead>
                  <tr>
  ...
  <div wire:key="form-container-persistent" :class="{ 'd-none': $wire.action !== 'create' && $wire.action !== 'edit' }">
    @include('livewire.casos.partials.banco-general.form')
  </div>
...
<script>
  function printTable() {
      ...
      const printContent = document.getElementById('casos-banco-general-table').innerHTML;
