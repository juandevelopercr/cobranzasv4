          ...
          <div class="nav-align-top nav-tabs-shadow mb-6">
            ...
            <div class="tab-content">
              ...
              <div class="tab-pane fade @if ($this->activeTab == 'product') show active @endif"
                ...
                <div wire:key="hist-line-manager-container" :class="{ 'd-none': !$wire.recordId }">
              ...
              <div class="tab-pane fade @if ($this->activeTab == 'charges') show active @endif"
                ...
                <div wire:key="hist-charge-manager-container" :class="{ 'd-none': !$wire.recordId }">
              ...
              <div class="tab-pane fade" id="navs-justified-cost-center" role="tabpanel">
                ...
                <div wire:key="hist-commission-manager-container" :class="{ 'd-none': !$wire.recordId }">
              ...
              <div class="tab-pane fade" id="navs-justified-document" role="tabpanel">
                ...
                <div wire:key="hist-documents-manager-container" :class="{ 'd-none': !$wire.recordId }">
