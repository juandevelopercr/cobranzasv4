        ...
        <div class="col-md-12">
          <div class="nav-align-top nav-tabs-shadow mb-6">
            <ul class="nav nav-tabs nav-fill" role="tablist">
              <li class="nav-item">
                <button type="button" class="nav-link @if($activeTab == 'invoice') active @endif"
                        wire:click="changeTab('invoice')" wire:loading.attr="disabled">
              ...
              <li class="nav-item">
                <button type="button" class="nav-link @if($activeTab == 'product') active @endif"
                        wire:click="changeTab('product')" wire:loading.attr="disabled">
                  <span class="d-none d-sm-block">
              ...
              <li class="nav-item">
                <button type="button" class="nav-link @if($activeTab == 'charges') active @endif"
                        wire:click="changeTab('charges')" wire:loading.attr="disabled">
                  <span class="d-none d-sm-block">
                    <i class="tf-icons bx bx-dollar bx-lg me-1_5 align-text-center"></i>
                    {{ __('Other Charge') }}
                  </span>
              ...
              <li class="nav-item">
                <button type="button" class="nav-link @if($activeTab == 'comisiones') active @endif"
                        wire:click="changeTab('comisiones')" wire:loading.attr="disabled">
                  <span class="d-none d-sm-block">
                    <i class="tf-icons bx bx-chart bx-lg me-1_5 align-text-center"></i>
              ...
              @endif
              <li class="nav-item">
                <button type="button" class="nav-link @if($activeTab == 'documentos') active @endif"
                        wire:click="changeTab('documentos')" wire:loading.attr="disabled">
                  <span class="d-none d-sm-block">
            ...
            <div class="tab-content">
              <div class="tab-pane fade @if($activeTab == 'invoice') show active @endif" role="tabpanel">
                @include('livewire.transactions.partials._form-proforma')
              </div>
              <div class="tab-pane fade @if($activeTab == 'product') show active @endif" role="tabpanel">
              ...
              <div class="tab-pane fade @if($activeTab == 'charges') show active @endif" role="tabpanel">
                <div class="{{ $this->recordId ? '' : 'd-none' }}">
              ...
              @if (in_array(session('current_role_name'), User::ROLES_ALL_DEPARTMENTS))
              <div class="tab-pane fade @if($activeTab == 'comisiones') show active @endif" role="tabpanel">
                <div class="{{ $this->recordId ? '' : 'd-none' }}">
                  ...
                  ], key('transaction-commission-'.$contador))
                </div>
              ...
              @endif
              <div class="tab-pane fade @if($activeTab == 'documentos') show active @endif" role="tabpanel">
                @if($this->recordId)
