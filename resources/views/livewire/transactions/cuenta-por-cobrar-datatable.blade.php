                    ...
                    <div class="row">
                        ...
                        <div class="col-md-10">
                            ...
                            justify-content-end flex-md-row flex-column mb-6 mb-md-0 mt-n6 mt-md-0">
                                ...
                                <div class="col-md-3 select2-primary mt-5 justify-content-left" x-data="select2Livewire({
                                    wireModelName: 'filter_cuenta_cobrar_type',
                                    postUpdate: true
                                })"
                                    x-init="init($refs.select)" wire:ignore wire:key="filter-select-{{ now()->timestamp }}"
                    ...
                    @can('view-proformas')
                        <div class="card-datatable table-responsive">
                            <table class="table table-sm mb-0 border-top table-hover dataTable no-footer"
                                id="transaction-table" style="width: 100%;">
                                <thead>
                                    <tr>
