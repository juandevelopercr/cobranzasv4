    ...
    <form wire:submit.prevent="{{ $action == 'edit' ? 'update' : 'store' }}" class="card-body">
        ...
        <div class="row g-6">
            <div class="col-md-4">
                ...
                <div wire:ignore>
                    <select class="form-select identification_type-select" id="identification_type_id"
                        ...
                        @foreach ($this->identificationTypes as $identificationType)
                            <option value="{{ $identificationType->id }}">
                                {{ $identificationType->code . '-' . $identificationType->name }}</option>
                        @endforeach
                    </select>
                </div>
            ...
            <div class="col-md-4 fv-plugins-icon-container">
                ...
                <div class="input-group input-group-merge has-validation">
                    ...
                    <input type="text" wire:model="identification" id="identification"
                        ...
                        placeholder="{{ __('Identification') }}" aria-label="{{ __('Identification') }}">

                    <!-- Botón con spinner -->
                    <button type="button" class="btn btn-primary" wire:click="searchClient('cedula')"
            ...
            <div class="col-md-4 fv-plugins-icon-container">
                ...
                <div class="input-group input-group-merge has-validation">
                    ...
                    <!-- Botón con spinner -->
                    <button type="button" class="btn btn-primary" wire:click="searchClient('name')"
                        wire:loading.attr="disabled">
                        <!-- Spinner visible mientras se ejecuta la acción -->
            ...
            <div class="col-md-4 select2-primary fv-plugins-icon-container" x-data="select2Livewire({
                ...
                <select x-ref="select" id="condition_sale_id"
                    ...
                    @foreach ($this->conditionSeles as $conditionSele)
                        <option value="{{ $conditionSele->id }}">{{ $conditionSele->code . '-' . $conditionSele->name }}
                        </option>
                    @endforeach
                </select>
            ...
            <div class="col-md-4 select2-primary fv-plugins-icon-container" x-data="select2Livewire({
                ...
                <select x-ref="select" id="pay_term_number" {{ $condition_sale_id != '02' ? 'disabled' : '' }}
            ...
            <div class="col-md-8 fv-plugins-icon-container" x-data="select2LivewireMultipleWithToggle({
                wireModelName: 'economicActivities',
                postUpdate: true
            })" x-init="init($refs.select)"
                wire:ignore>
                <label class="form-label" for="economicActivities">{{ __('Economic Activity') }}</label>
                <select x-ref="select" id="economicActivities" class="form-select" multiple>
            ...
            <div class="col-md-4">
                ...
                <div wire:ignore>
                    <select class="form-select invoice_type-select" id="invoice_type" wire:model="invoice_type">
                        <option value="">{{ __('Seleccione...') }}</option>
        ...
        <div class="row g-6">
            <div class="col-md-3 select2-primary fv-plugins-icon-container">
                ...
                <div wire:ignore>
                    <select wire:model="exoneration_type_id" id="exoneration_type_id"
                        class="select2 form-select @error('exoneration_type_id') is-invalid @enderror">
                        <option value="">{{ __('Seleccione...') }}</option>
                        @foreach ($this->exhonerations as $exhoneration)
                            <option value="{{ $exhoneration->id }}">
                                {{ $exhoneration->code . '-' . $exhoneration->name }}</option>
                        @endforeach
                    </select>
                </div>
            ...
            @if ($exoneration_type_id == '99')
                <div class="col-md-3 fv-plugins-icon-container">
                    <label class="form-label" for="exoneration_doc_other">{{ __('Document No.') }}
                        {{ __('Other') }}</label>
                    <div class="input-group input-group-merge has-validation">
            ...
            <div class="col-md-3 fv-plugins-icon-container">
                ...
                <div class="input-group input-group-merge has-validation">
                    ...
                    <input type="text" wire:model="exoneration_doc" id="exoneration_doc"
                        class="form-control @error('exoneration_doc') is-invalid @enderror"
                ...
                <div class="col-md-3 fv-plugins-icon-container">
                    ...
                    <div x-data="cleaveLivewire({
                        ...
                        <div class="input-group input-group-merge has-validation">
                            ...
                            <input type="text" id="exoneration_article" x-ref="cleaveInput" wire:ignore
                                class="form-control js-input-exoneration_article" />
                        </div>
                    </div>
            ...
            @if (in_array($exoneration_type_id, ['2', '3', '6', '7', '8']))
                <div class="col-md-3 fv-plugins-icon-container">
                    ...
                    <div x-data="cleaveLivewire({
                        ...
                        <div class="input-group input-group-merge has-validation">
                            <span class="input-group-text"><i class="bx bx-hash"></i></span>
                            <input type="text" id="exoneration_inciso" x-ref="cleaveInput" wire:ignore
                                class="form-control js-input-exoneration_inciso" />
                        </div>
                    </div>
            ...
            <div class="col-md-3 select2-primary fv-plugins-icon-container">
                ...
                <div wire:ignore>
                    <select wire:model="exoneration_institution_id" id="exoneration_institution_id"
                        class="select2 form-select @error('exoneration_institution_id') is-invalid @enderror">
                        <option value="">{{ __('Seleccione...') }}</option>
            ...
            @if ($exoneration_institution_id == '99')
                <div class="col-md-3 fv-plugins-icon-container">
                    <label class="form-label" for="exoneration_institute_other">{{ __('Institute Name') }}
                        {{ __('Other') }}</label>
                    <div class="input-group input-group-merge has-validation">
                        <span class="input-group-text"><i class="bx bx-detail"></i></span>
                        <input type="text" wire:model="exoneration_institute_other"
                            id="exoneration_institute_other"
            ...
            <div class="col-md-3 fv-plugins-icon-container">
                ...
                <div x-data="cleaveLivewire({
                    ...
                    <div class="input-group input-group-merge has-validation">
                        <input type="text" id="exoneration_percent" x-ref="cleaveInput" wire:ignore
                            class="form-control js-input-exoneration_percent" />
                    </div>
                </div>
            ...
            <div class="col-md-4 fv-plugins-icon-container">
                ...
                <div class="input-group input-group-merge has-validation">
                    ...
                    <input type="text" wire:model="other_signs" id="other_signs" name="other_signs"
                        class="form-control @error('other_signs') is-invalid @enderror"
                        placeholder="{{ __('Other Signs') }}" aria-label="{{ __('Other Signs') }}">
                </div>
                @error('other_signs')
                    <div class="text-danger mt-1">{{ $message }}</div>
                @enderror
        ...
        <div class="row g-6">
            <div class="col-md-6 fv-plugins-icon-container">
                <div class="form-check form-switch ms-2 my-2">
                    ...
                    <input type="checkbox" class="form-check-input" id="active" wire:model.live="active"
                        {{ $active == 1 ? 'checked' : '' }} />
...
<!-- Modal de resultados -->
@if ($showModalCedula)
    <div class="modal fade show" id="searchModal" tabindex="-1" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <button type="button" class="btn-close" wire:click="$set('showModalCedula', false)"
                        ...
                        <div class="card-datatable table-responsive">
                            <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper dt-bootstrap5 no-footer">
                                <table class="table table-sm mb-0 border-top table-hover dataTable no-footer"
                                    id="identification-table" style="width: 100%;">
                                    <thead>
                                        <tr>
                                            <th>#</th>
                                            <th>{{ __('Name') }}</th>
