        ...
        <div class="table-responsive">
            <table class="table table-sm table-borderless mb-0" style="width: auto; margin-left: auto;">
                <tbody>
                    ...
                    <tr>
                        <th class="text-start fw-bold pe-4 text-danger">- Bloqueado (Electrónico y Ck)</th>
                    ...
                    <tr>
                        <th class="text-start fw-bold pe-4 text-danger">- Bloqueado (Depósito)</th>
                        <td class="text-end text-nowrap" style="width: 200px;">₡ {{ $bloqueado_deposito_colones }}</td>
                        <td class="text-end text-nowrap" style="width: 200px;">$ {{ $bloqueado_deposito_dolares }}</td>
                    </tr>
                    <tr class="border-top">
                        <th class="text-start fw-bold pe-4">Saldo Final</th>
                        <td class="text-end text-nowrap fw-bold" style="width: 200px;">₡ {{ $saldo_final_colones }}
                        </td>
                        <td class="text-end text-nowrap fw-bold" style="width: 200px;">$ {{ $saldo_final_dolares }}
                        </td>
                    </tr>
                </tbody>
            </table>
