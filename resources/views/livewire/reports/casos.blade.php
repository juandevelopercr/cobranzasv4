<div class="card">
  <h4 class="card-header pb-0 text-md-start text-center ms-n2">{{ __('Reporte de Casos') }}</h4>
    ...
    <div class="dataTables_wrapper dt-bootstrap5 no-footer">
      <form wire:submit.prevent="exportExcel">
        <div class="row g-6">
          ...
          <div class="col-md-3 select2-primary fv-plugins-icon-container">
            <label class="form-label" for="filter_banco">{{ __('Banco') }}</label>
            <div wire:ignore>
              <select wire:model="filter_banco" id="filter_banco" class="select2 form-select @error('filter_banco') is-invalid @enderror">
                <option value="">{{ __('Seleccione...') }}</option>
