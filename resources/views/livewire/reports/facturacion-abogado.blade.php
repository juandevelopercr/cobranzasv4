<div class="card">
  <h4 class="card-header pb-0 text-md-start text-center ms-n2">{{ __('Reporte de Facturación por Abogado') }}</h4>
        ...
        if (element) {
          ...
          $(`#${id}`).on('change', function() {
            ...
            if (newValue !== livewireValue) {
              ...
              const specificIds = ['filter_abogado']; // Lista de IDs específicos
