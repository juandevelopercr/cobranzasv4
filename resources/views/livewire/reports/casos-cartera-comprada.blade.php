<div class="card">
  <h4 class="card-header pb-0 text-md-start text-center ms-n2">{{ __('Reporte de Casos de Cartera Comprada') }}</h4>
        ...
        if (element) {
          ...
          $(`#${id}`).on('change', function() {
            ...
            if (newValue !== livewireValue) {
              ...
              const specificIds = ['filter_banco', 'filter_currency']; // Lista de IDs específicos
