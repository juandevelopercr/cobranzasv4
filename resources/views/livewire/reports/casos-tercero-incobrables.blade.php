<div class="card">
  <h4 class="card-header pb-0 text-md-start text-center ms-n2">{{ __('Reporte de Casos de Lafise Incobrables') }}</h4>
        ...
        <div class="row g-6">
          <div class="col-md-12 mt-4">
            <div class="p-3 border rounded bg-light">
              ...
              <ol class="text-dark" style="font-size: 0.9rem; padding-left: 20px; line-height: 1.4; margin-bottom: 0;">
                ...
                <li>
                  Para reportes como <em>incobrables, arreglos de pago, prescritos o terminados</em>, seleccionar el ítem respectivo.
                </li>
              </ol>
            </div>
          </div>
