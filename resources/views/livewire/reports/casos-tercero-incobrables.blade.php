<div class="card">
    <h4 class="card-header pb-0 text-md-start text-center ms-n2">{{ __('Reporte de Casos de Terceros Incobrables') }}
    </h4>
            ...
            <form wire:submit.prevent="exportExcel">
                <div class="row g-6">
                    ...
                    <div class="col-md-3 select2-primary fv-plugins-icon-container">
                        ...
                        <div wire:ignore>
                            <select wire:model="filter_contact" id="filter_contact"
                                class="select2 form-select @error('filter_contact') is-invalid @enderror">
                                <option value="">{{ __('Seleccione...') }}</option>
                    ...
                    <div class="col-md-12 mt-4">
                        <div class="p-3 border rounded bg-light">
                            <p class="text-dark mb-2" style="font-size: 0.9rem;">
                                <strong>Leyenda:</strong> Para que se desplieguen los datos debe cumplir con las
                                siguientes condiciones en el formulario:
                            </p>

                            <ol class="text-dark"
                                style="font-size: 0.9rem; padding-left: 20px; line-height: 1.4; margin-bottom: 0;">
                                ...
                                <li>
                                    Para reportes como <em>incobrables, arreglos de pago, prescritos o terminados</em>,
                        ...
                        $(`#${id}`).on('change', function() {
                            ...
                            if (newValue !== livewireValue) {
                                ...
                                const specificIds = ['filter_abogado', 'filter_asistente',
                                    'filter_banco', 'filter_currency', 'filter_contact'
