<div class="card">
  <h4 class="card-header pb-0 text-md-start text-center ms-n2">{{ __('Reporte de Antiguedad de Saldo') }}</h4>
      ...
      <form wire:submit.prevent="exportExcel">
        <div class="row g-6">
          ...
          <div class="col-md-6 fv-plugins-icon-container"
              ...
              wire:ignore>
              <label class="form-label d-block" for="filter_centroCosto">{{ __('Centro de Costo Excluyentes') }}</label>
        ...
        if (element) {
          ...
          $(`#${id}`).on('change', function() {
            ...
            if (newValue !== livewireValue) {
              ...
              const specificIds = ['filter_department','filter_currency']; // Lista de IDs específicos
