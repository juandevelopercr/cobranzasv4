<div class="card">
  <h4 class="card-header pb-0 text-md-start text-center ms-n2">{{ __('Reporte de Casos de Cafsa Incobrables') }}</h4>
          ...
          <div class="col-md-12 mt-4">
            <div class="p-3 border rounded bg-light">
              ...
              <ol class="text-dark" style="font-size: 0.9rem; padding-left: 20px;">
                <li>
                  Obtiene los casos donde el estado del Proceso General sea igual a
                  <em>"INCOBRABLE"</em>.
                </li>
              </ol>
            </div>
