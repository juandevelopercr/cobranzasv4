<div class="card">
  <h4 class="card-header pb-0 text-md-start text-center ms-n2">{{ __('Reporte de Casos de Lafise Terminados') }}</h4>
          ...
          <div class="col-md-12 mt-4">
            <div class="p-3 border rounded bg-light">
              ...
              <ol class="text-dark" style="font-size: 0.9rem; padding-left: 20px;">
                <li>
                  En la casilla de <em>status de la operación</em> debe tener asignado:
                  <em>CANCELADO</em>.
                </li>
              </ol>
            </div>
