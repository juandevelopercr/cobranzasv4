<div class="card">
  <h4 class="card-header pb-0 text-md-start text-center ms-n2">{{ __('Reporte de Facturación con 2% retención') }}</h4>
      ...
      <form wire:submit.prevent="exportExcel">
        <div class="row g-6">
          ...
          <div class="col-md-3 fv-plugins-icon-container">
            <label class="form-label" for="filter_date">{{ __('Fecha de depósito') }}</label>
