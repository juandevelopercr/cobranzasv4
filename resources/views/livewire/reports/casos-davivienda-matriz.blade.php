<div class="card">
  <h4 class="card-header pb-0 text-md-start text-center ms-n2">{{ __('Reporte de Casos de Davivienda Matriz TC y CE') }}</h4>
            ...
            <div class="p-3 border rounded bg-light">
              ...
              <ol class="text-dark" style="font-size: 0.9rem; padding-left: 20px;">
                ...
                <li>
                  ...
                  <em>Crédito Comercial, Crédito Credifácil, Crédito de Consumo, Crédito Libranza, Crédito Personal y Tarjeta de Crédito</em>.
                </li>
              </ol>
            </div>
          </div>
