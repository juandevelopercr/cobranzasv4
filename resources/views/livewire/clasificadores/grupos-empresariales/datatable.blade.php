<div>
  @if($action == 'list')
    ...
    <div class="card">
      <h4 class="card-header pb-0 text-md-start text-center ms-n2">{{ __('Grupos empresariales') }}</h4>
              ...
              <div
                ...
                <div class="dt-buttons btn-group flex-wrap">
                  ...
                  @can('export-classifiers')
                    <livewire:clasificadores.grupos-empresariales.grupo-empresarial-datatable-export />
                  @endcan
                  ...
                  @livewire('components.datatable-settings', [
                    'datatableName' => 'classifier-grupos-empresariales-datatable',
                    'availableColumns' => $this->columns,
                    'perPage' => $this->perPage,
                  ],
                  key('classifier-grupos-empresariales-datatable-config'))
  ...
  @if($action == 'create' || $action == 'edit')
    @include('livewire.clasificadores.grupos-empresariales.partials.form')
  @endif
</div>
