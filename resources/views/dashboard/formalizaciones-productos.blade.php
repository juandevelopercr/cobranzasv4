...
@section('title', __('Grafico de formalizaciones productos'))
...
<script src="{{ asset('vendor/fusioncharts/fusioncharts.js') }}"></script>
  ...
  <script src="{{ asset('js/formalizaciones-productos-handler.js') }}"></script>
@endpush

@section('content')
  @livewire('dashboards.formalizacion-producto')
@endsection
