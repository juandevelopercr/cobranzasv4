# Plan de pruebas — Terceros

Carpeta de vistas: `resources/views/livewire/casos/partials/terceros/panels/`
...
| Campo (wire:model) | Etiqueta | Tipo probable |
|---|---|---|
| `tfecha_terminacion` | Fecha de Terminación |  |
| `testado_proceso_id` | Estado Proceso General |  |
