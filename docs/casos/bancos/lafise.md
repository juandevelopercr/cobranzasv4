# Plan de pruebas — Banco Lafise

Carpeta de vistas: `resources/views/livewire/casos/partials/lafise/panels/`
...
| `amonto_avaluo` | Monto avaluo | 💰 dinero/numérico |
| `afecha_avaluo` | Fecha avaluo | 💰 dinero/numérico |
| `aembargo_cuentas` | Embargos cuentas |  |
| `aembargo_salarios` | Embargos salarios |  |
| `aembargo_muebles` | Embargos Muebles |  |
| `aembargo_inmuebles` | Embargos Inmuebles |  |
| `aretenciones_con_giro` | Retenciones con giro | 💰 dinero/numérico |
| `afecha_ultimo_giro` | Fecha de último giro |  |
...
| `pmonto_estimacion_demanda_dolares` | Estimación dólares Demanda en la Presentación | 💰 dinero/numérico |
| `pexpectativa_recuperacion_id` | Expectativa Recuperación |  |
| `pnumero_tarjeta` | Número de tarjeta |  |
| `pnombre_persona_juridica` | Nombre de la Persona Jurídica |  |
| `pnumero_cedula_juridica` | Número de cédula jurídica |  |
| `aestado_operacion` | Estatus de Operaciòn |  |
...
| `asaldo_capital_operacion` | Saldo Capital Operación | 💰 dinero/numérico |
