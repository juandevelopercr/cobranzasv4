# Plan de pruebas — DAVIBANK (código interno "Scotiabank")

Carpeta de vistas: `resources/views/livewire/casos/partials/scotiabank/panels/`
...
| `afecha_levantamiento` | Fecha aprobación levantamiento |  |
...
| `fecha_inicio_retenciones` | Fecha de inicio de retenciones | 💰 dinero/numérico |
| `fecha_prescripcion` | Fecha de Prescripción |  |
| `fecha_pruebas` | Fecha de Pruebas |  |
| `motivo_terminacion` | Motivo de Terminación |  |
| `dhonorarios` | Honorarios Legales Colones | 💰 dinero/numérico |
| `honorarios_legales_dolares` | Honorarios Legales Dólares | 💰 dinero/numérico |
...
| `asaldo_capital_operacion` | Saldo Inicial | 💰 dinero/numérico |
...
| `pfecha_informe` | Fecha de informe |  |
...
| `pfecha_ultimo_giro` | Fecha de último giro |  |
