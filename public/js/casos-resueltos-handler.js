window.renderFusionCharts = function (chartData) {
  ...
  if (mscolumn3dFirmasContainer) {
    ...
    const hasDataFirmas = chartData.mscolumn3d_resueltos_year?.data?.categories?.[0]?.category?.length > 0;
    ...
    if (!hasDataFirmas) {
      ...
      <div class="no-data-container">
        <div class="no-data-content">
          ...
          <p class="no-data-message">
            ${chartData.mscolumn3d_resueltos_year?.caption || ''}
            ${chartData.mscolumn3d_resueltos_year?.subCaption ? '| ' + chartData.mscolumn3d_resueltos_year.subCaption : ''}
          </p>
      ...
      try {
        const chartConfig = {
          ...
          dataSource: {
            chart: {
              caption: chartData.mscolumn3d_resueltos_year.caption || 'Firmas por abogado',
              subCaption: chartData.mscolumn3d_resueltos_year.subCaption || '',
              xAxisName: chartData.mscolumn3d_resueltos_year.xAxisName || 'Abogado',
              yAxisName: chartData.mscolumn3d_resueltos_year.yAxisName || 'Firmas',
            ...
            data:
              chartData.mscolumn3d_resueltos_year.data.categories?.[0]?.category?.map((category, index) => {
                return {
                  label: category.label,
                  value: chartData.mscolumn3d_resueltos_year.data.dataset?.[0]?.data?.[index]?.value || 0
                };
              }) || []
          }
        };
